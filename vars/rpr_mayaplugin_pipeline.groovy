                    ...
                    dir("jobs_launcher") {
                        ...
                        try {
                            if (options['isPreBuilt']) {
                                ...
                                bat """
                                    build_reports.bat ..\\summaryTestResults "Maya" ${options.commitSHA} ${options.projectBranchName} \"${utils.escapeCharsByUnicode(options.commitMessage)}\" \"${utils.escapeCharsByUnicode(engineName)}\"
                                """
                            }
                        } catch (e) {
