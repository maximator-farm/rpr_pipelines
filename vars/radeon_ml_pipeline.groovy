            ...
            switch (osName) {
                case 'Windows':
                    withEnv(["PATH=C:\\Python38;C:\\Python38\\Scripts;${PATH}"]) {
                        ...
                        python run_tests.py -t ../${options.PRJ_NAME}-TestAssets -t ../rml_release/test_app.exe -i ../${options.PRJ_NAME}-TestAssets -o results -c true >> ${STAGE_NAME}.ft.log 2>&1
                ...
                default:
                    sh """
                        ...
                        python3.8 run_tests.py -t ../${options.PRJ_NAME}-TestAssets -t ../rml_release/test_app -i ../${options.PRJ_NAME}-TestAssets -o results -c true >> ${STAGE_NAME}.ft.log 2>&1
