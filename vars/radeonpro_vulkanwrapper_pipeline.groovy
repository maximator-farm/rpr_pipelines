    ...
    configurations.each() {
        ...
        try {
            ...
            if (KEY == "RRNEXT_OFF") {
                ...
                xcopy external\\SpirvCross\\Release\\SpirvCross.lib publish-archive-norrn\\lib\\SpirvCross.lib*
                ...
                xcopy external\\SpirvCross\\Debug\\SpirvCrossd.lib publish-archive-norrn\\libd\\SpirvCrossd.lib*
...
def executeBuildLinux(Map options, String osName="linux")
{
    ...
    if (osName == "Ubuntu18") {
        ...
        cp external/SpirvCross/libSpirvCross.a publish-archive-norrn/lib/libSpirvCross.a
