                    ...
                    try {
                        if (fileExists("${test}.ipynb")) {
                            ...
                            bat """
                                ...
                                jupyter nbconvert --to html --execute --ExecutePreprocessor.timeout=${options.notebooksTimeout} --kernel_name upscalers_pytorch --output tested/tested_${test} ${test}.ipynb >> ..\\${STAGE_NAME}_${test}.log 2>&1
                            """
