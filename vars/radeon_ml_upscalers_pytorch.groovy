                    ...
                    try {
                        if (fileExists("${test}.ipynb")) {
                            ...
                            bat """
                                ...
                                jupyter nbconvert --to html --allow-errors --execute --ExecutePreprocessor.timeout=${options.notebooksTimeout} --ExecutePreprocessor.kernel_name=upscalers_pytorch --output tested/tested_${test} ${test}.ipynb >> ..\\${STAGE_NAME}_${test}.log 2>&1
                            """
